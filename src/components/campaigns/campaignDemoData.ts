...
export const demoLinks: CampaignLink[] = [
  ...
  { id: "link-4", campaign_id: "camp-4", url: "https://example.com/bf-sale", utm_source: "email", utm_medium: "blast", utm_campaign: "black-friday-flash", clicks: 22000, leads: 3100, revenue: 52000, conversion_rate: 14.1 },
  { id: "link-5", campaign_id: "camp-4", url: "https://example.com/bf-ig", utm_source: "instagram", utm_medium: "story", utm_campaign: "black-friday-flash", clicks: 15000, leads: 2512, revenue: 37200, conversion_rate: 16.7 },
];
...
export const demoAssets: CampaignAsset[] = [
  ...
  { id: "asset-5", campaign_id: "camp-4", name: "BF Countdown Reel", type: "reel", clicks: 12000, leads: 1800, revenue: 28000, utm_tag: "bf-countdown" },
  { id: "asset-6", campaign_id: "camp-4", name: "BF Email Blast", type: "email", clicks: 22000, leads: 3100, revenue: 52000, utm_tag: "bf-email-blast" },
];
...
export const demoNotes: CampaignNote[] = [
  ...
  { id: "note-3", campaign_id: "camp-4", content: "Best Black Friday we've ever had. Email list was the #1 driver. Need to double down on list building for next year.", created_at: "2025-12-03T09:00:00Z", author: "Sarah Chen" },
];
