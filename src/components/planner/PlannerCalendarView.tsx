                ...
                {(viewMode === "day" ? [currentDate] : weekDays).map((day) => {
                  ...
                  return (
                    <div
                      ...
                      className="border-r border-border last:border-r-0 min-h-[32px] p-1 flex flex-col gap-0.5 cursor-pointer hover:bg-accent/10 transition-colors overflow-hidden"
