...
const ACTION_TYPE_LABELS: Record<string, { label: string; variant: 'default' | 'secondary' | 'destructive' | 'outline'; category: string }> = {
  ...
  pro_granted: { label: 'Pro Granted', variant: 'default', category: 'subscriptions' },
  content_vault_granted: { label: 'Vault Granted', variant: 'default', category: 'subscriptions' },
  upgraded_to_pro: { label: 'Upgraded to Pro', variant: 'default', category: 'subscriptions' },
  downgraded_to_vault: { label: 'Downgraded to Vault', variant: 'secondary', category: 'subscriptions' },
