  ...
  return (
    <Card>
      <CardHeader className="flex flex-row items-center justify-between pb-1 md:pb-2 p-3 md:p-6">
        <CardTitle className="text-xs md:text-sm font-medium">AI Calls</CardTitle>
        <Sparkles className="h-3 w-3 md:h-4 md:w-4 text-violet-500 hidden sm:block" />
      </CardHeader>
      <CardContent className="p-3 pt-0 md:p-6 md:pt-0">
        {isLoading ? (
          ...
          <>
            <div className="text-xl md:text-2xl font-bold">{data?.totalCalls || 0}</div>
