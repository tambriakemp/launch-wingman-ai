...
export const TimeEffortSection = ({
  timeEffortElements,
  niche,
  targetAudience,
  primaryPainPoint,
  ...
  const isComplete = timeEffortElements.length > 0;
      ...
      <CardHeader className="pb-4">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            <h3 className="font-semibold text-base">TIME + EFFORT</h3>
            <p className="text-sm text-muted-foreground">How easy is the path?</p>
          </div>
          {isComplete && (
