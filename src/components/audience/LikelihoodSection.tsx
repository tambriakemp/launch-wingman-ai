...
export const LikelihoodSection = ({
  mainObjections,
  likelihoodElements,
  niche,
  targetAudience,
  ...
  const isComplete = !!(mainObjections && likelihoodElements.length > 0);
      ...
      <CardHeader className="pb-4">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            <h3 className="font-semibold text-base">PERCEIVED LIKELIHOOD</h3>
            <p className="text-sm text-muted-foreground">Why will they believe it works?</p>
          </div>
          {isComplete && (
