    ...
    <div className="hidden md:block" style={{ maxWidth: 1200, margin: "0 auto", padding: "32px 40px 96px" }}>
      ...
      <section style={{ padding: "32px 0 0" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 14 }}>
          <Eyebrow color={FG_MUTED}>Chapters · 6</Eyebrow>
          <div style={{ fontFamily: "var(--font-body)", fontSize: 12, color: FG_MUTED }}>
            {totalEntries} entries · curated for your launch
          </div>
        </div>
        <div style={{ display: "grid", gridTemplateColumns: `repeat(${chapters.length},1fr)`, gap: 8 }}>
          {chapters.map((c) => {
            ...
            return (
              <div
                ...
                style={{
                  ...
                  border: isActive ? "0" : `1px solid ${HAIR}`,
                  borderRadius: 12,
              ...
              >
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: 6 }}>
                  <span
                    style={{
                      ...
                      color: isActive ? TERRA : FG_MUTED,
                    }}
                  >
                    {c.num} · {c.weeks}
                  </span>
                  {isDone && <Check className="w-3 h-3" style={{ color: "hsl(var(--moss-500, 142 30% 40%))" }} strokeWidth={2.5} />}
                  {isActive && <span style={{ width: 7, height: 7, borderRadius: 999, background: TERRA }} />}
                </div>
                <div
                  style={{
                    fontFamily: "var(--font-display)",
                ...
                <div
                  style={{
                    fontFamily: "var(--font-body)",
                    fontSize: 11.5,
                    color: isActive ? "rgba(251,247,241,0.65)" : FG_MUTED,
                  }}
                >
                  {c.count} entries
                </div>
  ...
  return (
    <div className="md:hidden" style={{ background: PAPER, paddingBottom: 32 }}>
      ...
      <div style={{ padding: "24px 0 4px" }}>
        <div style={{ padding: "0 22px 10px", display: "flex", justifyContent: "space-between", alignItems: "flex-end" }}>
          <Eyebrow color={FG_MUTED}>Chapters</Eyebrow>
          <span style={{ fontFamily: "var(--font-body)", fontSize: 13, fontWeight: 500, color: TERRA }}>6 ›</span>
        </div>
        <div
          style={{
            display: "flex",
              ...
              >
                <span
                  style={{
                    ...
                    color: isActive ? TERRA : isDone ? "hsl(var(--moss-500, 142 30% 40%))" : FG_MUTED,
                  }}
                >
                  {c.num}
                </span>
                ...
                {isDone && <Check className="w-3 h-3" strokeWidth={2.6} />}
                {isActive && <span style={{ width: 6, height: 6, borderRadius: 999, background: TERRA }} />}
              </div>
            );
          })}
        </div>
