    ...
    <ProjectLayout>
      <div className="max-w-2xl mx-auto pb-24">
        ...
        <div className="pt-2">
          ...
          <div className="fixed bottom-0 left-0 right-0 border-t border-border bg-background/95 backdrop-blur-sm py-3 px-6 flex items-center justify-center gap-6 z-50">
