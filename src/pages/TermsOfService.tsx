...
const TermsOfService = () => {
  return (
    <div className="landing-theme min-h-screen bg-background text-foreground font-sans">
      <SEO
        title="Terms of Service — Launchely"
        description="The terms governing your use of Launchely's launch planning platform and services."
        path="/terms"
        breadcrumbs={[
          { name: "Home", path: "/" },
      ...
      <div className="container mx-auto px-4 pt-32 pb-16 max-w-4xl">
        ...
        <h1 className="font-serif text-4xl md:text-5xl font-semibold mb-4 tracking-tight">Terms of Service</h1>
        <p className="text-muted-foreground mb-8">Last updated: December 17, 2024</p>

        <div className="prose prose-gray max-w-none space-y-8">
          <section>
            <h2 className="font-serif text-2xl md:text-3xl font-semibold mb-4 tracking-tight">1. Acceptance of Terms</h2>
          ...
          <section>
            <h2 className="font-serif text-2xl md:text-3xl font-semibold mb-4 tracking-tight">2. Description of Service</h2>
            <p className="text-muted-foreground">
          ...
          <section>
            <h2 className="font-serif text-2xl md:text-3xl font-semibold mb-4 tracking-tight">3. User Accounts</h2>
          ...
          <section>
            <h2 className="font-serif text-2xl md:text-3xl font-semibold mb-4 tracking-tight">4. Subscription and Payments</h2>
            <p className="text-muted-foreground mb-4">
          ...
          <section>
            <h2 className="font-serif text-2xl md:text-3xl font-semibold mb-4 tracking-tight">5. Acceptable Use</h2>
            <p className="text-muted-foreground mb-4">
          ...
          <section>
            <h2 className="font-serif text-2xl md:text-3xl font-semibold mb-4 tracking-tight">6. Intellectual Property</h2>
            <p className="text-muted-foreground mb-4">
          ...
          <section>
            <h2 className="font-serif text-2xl md:text-3xl font-semibold mb-4 tracking-tight">7. AI-Generated Content</h2>
            <p className="text-muted-foreground">
          ...
          <section>
            <h2 className="font-serif text-2xl md:text-3xl font-semibold mb-4 tracking-tight">8. Disclaimer of Warranties</h2>
            <p className="text-muted-foreground">
          ...
          <section>
            <h2 className="font-serif text-2xl md:text-3xl font-semibold mb-4 tracking-tight">9. Limitation of Liability</h2>
            <p className="text-muted-foreground">
          ...
          <section>
            <h2 className="font-serif text-2xl md:text-3xl font-semibold mb-4 tracking-tight">10. Indemnification</h2>
            <p className="text-muted-foreground">
          ...
          <section>
            <h2 className="font-serif text-2xl md:text-3xl font-semibold mb-4 tracking-tight">11. Termination</h2>
            <p className="text-muted-foreground">
          ...
          <section>
            <h2 className="font-serif text-2xl md:text-3xl font-semibold mb-4 tracking-tight">12. Governing Law</h2>
            <p className="text-muted-foreground">
          ...
          <section>
            <h2 className="font-serif text-2xl md:text-3xl font-semibold mb-4 tracking-tight">13. Contact Information</h2>
            <p className="text-muted-foreground">
