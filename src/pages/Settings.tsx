          ...
          <Card variant="elevated">
            ...
            <CardContent>
              <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-3">
                    {instagramConnection?.avatar_url ? (
                      <div className="w-10 h-10 rounded-lg overflow-hidden ring-2 ring-[#E4405F]/20">
                        <img 
                          src={instagramConnection.avatar_url} 
                          alt={instagramConnection.account_name || 'Instagram User'} 
                          className="w-full h-full object-cover"
                          onError={(e) => {
                            e.currentTarget.style.display = 'none';
                            e.currentTarget.parentElement?.classList.add('bg-gradient-to-br', 'from-[#833AB4]', 'via-[#E4405F]', 'to-[#FCAF45]', 'flex', 'items-center', 'justify-center');
                          }}
                        />
                      </div>
                    ) : (
                  ...
                  <div className="flex items-center gap-3">
                    {facebookConnection?.avatar_url ? (
                      <div className="w-10 h-10 rounded-lg overflow-hidden ring-2 ring-[#1877F2]/20">
                        <img 
                          src={facebookConnection.avatar_url} 
                          alt={facebookConnection.account_name || 'Facebook Page'} 
                          className="w-full h-full object-cover"
                          onError={(e) => {
                            e.currentTarget.style.display = 'none';
                            e.currentTarget.parentElement?.classList.add('bg-[#1877F2]', 'flex', 'items-center', 'justify-center');
                          }}
                        />
                      </div>
                    ) : (
                ...
                {/* TikTok Connection - Single unified connection based on active environment */}
                {(() => {
                        ...
                        {activeConnection?.avatar_url ? (
                          <div className={`w-10 h-10 rounded-lg overflow-hidden ring-2 ${isSandbox ? 'ring-gray-400/20' : 'ring-black/20 dark:ring-white/20'}`}>
                            <img 
                              ...
                              alt={activeConnection.account_name || 'TikTok User'} 
                              className="w-full h-full object-cover"
                              onError={(e) => {
                                e.currentTarget.style.display = 'none';
                                e.currentTarget.parentElement?.classList.add(isSandbox ? 'bg-gray-700' : 'bg-black', 'flex', 'items-center', 'justify-center');
                              }}
                            />
                          </div>
                        ) : (
