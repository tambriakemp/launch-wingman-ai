...
export const FUNNEL_OFFER_STACK_VOICE_SCRIPTS: Record<string, string> = {
  'content-to-offer-funnel': `The Content to Offer funnel is the most straightforward approach — your content leads directly to your paid offer. Your Core Offer is the centerpiece of this funnel, whether it's a course, coaching program, digital product, or service. You create valuable content on social media or other platforms that naturally leads people to learn more and eventually purchase. This approach works especially well when you already have an engaged audience who trusts you. Optionally, you can add an Upsell — an additional offer presented after someone purchases, giving them a chance to go deeper or get more support.`,
