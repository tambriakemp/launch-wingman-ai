...
export const TASK_TEMPLATES: TaskTemplate[] = [
  ...
  // ==================== MARKETING PHASE ====================
  // Goal: "Build the machine that gets your offer in front of people — sequences live, content scheduled, tracking set up, engine running."

  {
    taskId: 'marketing_email_sequence',
    title: 'Write and schedule your 7-email launch sequence',
    phase: 'marketing',
    funnelTypes: ['all'],
    order: 1,
    priority: 1,
    ...
    skipReasonRequired: false,
    completionCriteria: [
      'All 7 emails are written',
      'Emails are loaded into your email platform',
      'Each email is scheduled to send at a specific date and time',
    ],
    whyItMatters: 'Email is the highest-converting channel you have — and it runs automatically once it\'s set up. Your audience sees your social posts once. Your email sequence catches everyone who clicked, opened, or showed interest and walks them toward the sale without you doing anything extra. This is the infrastructure that separates a launch from a campaign.',
    instructions: [
      'Use the Email Sequence tool in Launchely to generate all 7 email drafts — it pulls from your messaging, transformation statement, and offer details',
      'Email 1 (The Announcement): What\'s coming, why now, who it\'s for. Send 7 days before open cart.',
      'Email 2 (The Origin Story): Why you built this. The moment you knew it was needed. Send 6 days before.',
      'Email 3 (The Problem): Describe the pain so specifically they feel seen. Not your pain — theirs. Send 5 days before.',
      'Email 4 (The Transformation): Who they become after. Results, specifics, not fluff. Send 4 days before.',
      'Email 5 (Social Proof + FAQ): Handle the 3 most common objections. Include proof if you have it. Send on open cart day.',
      'Email 6 (Last Chance Warning): Cart closes tomorrow. Here\'s what they lose if they wait. Send 24 hours before close.',
      'Email 7 (Cart Closes Today): Final email. Deadline is real. One clear link. Send 2-4 hours before close.',
      'Load all 7 into Systeme.io (or your email platform) and schedule each one at a specific date and time — not "send now"',
      'Send yourself a test of each email and read it in your inbox before marking this complete',
    ],
    inputType: 'form',
    inputSchema: {
      type: 'form',
      fields: [
        {
          name: 'email_platform',
          label: 'Which email platform are you using?',
          type: 'text',
          required: true,
          placeholder: 'e.g., Systeme.io, Mailchimp, ConvertKit, ActiveCampaign...',
          helperText: 'Systeme.io is recommended — it includes email sequences, landing pages, and checkout in one place.',
        },
        {
          name: 'open_cart_date',
          label: 'What is your open cart / launch date?',
          type: 'text',
          required: true,
          placeholder: 'e.g., June 15, 2025',
          helperText: 'Your emails will be scheduled backwards from this date.',
        },
        {
          name: 'close_cart_date',
          label: 'What is your close cart / deadline date?',
          type: 'text',
          required: true,
          placeholder: 'e.g., June 22, 2025',
          helperText: 'Your final two emails schedule from this date.',
        },
        {
          name: 'sequence_url',
          label: 'Link to your email sequence (optional)',
          type: 'text',
          required: false,
          placeholder: 'e.g., link to your sequence in Systeme.io',
          helperText: 'Paste a link to your sequence so you can reference it easily.',
        },
      ],
    },
    aiAssistModes: ['generate', 'examples'],
    route: '/projects/:id/tasks/marketing_email_sequence',
  },

  {
    taskId: 'marketing_content_creation',
    title: 'Create and schedule 2 weeks of launch content',
    phase: 'marketing',
    funnelTypes: ['all'],
    order: 2,
    priority: 1,
    ...
    skipReasonRequired: false,
    completionCriteria: [
      'At least 14 pieces of content are created',
      'Every piece has a written caption',
      'All content is scheduled in your Social Planner',
      'Content spans 7 days pre-launch and 7 days during launch window',
    ],
    whyItMatters: 'Most launches fail because the creator posts once and goes quiet. Two weeks of pre-scheduled content means your audience sees consistent momentum — before, during, and through your launch window — without you scrambling to create something new every day while also managing the launch itself. When content is scheduled in advance, you can focus entirely on engagement and responding to interested buyers.',
    instructions: [
      'Your 2-week content window: 7 days before open cart + 7 days during the launch window',
      'Mix of content types to create:',
      '— 4 carousels: educational content that builds authority in your topic (use the Carousel Builder)',
      '— 4 short-form video reels: one hook-driven, one origin story, one transformation, one objection-handler (use AI Avatar Studio)',
      '— 4 caption/static posts: personal, behind-the-scenes, social proof, or community-focused',
      '— 2 direct offer posts: one for cart open day, one for last day (deadline-driven)',
      'For each piece: write the caption first using the Hook Generator to find your strongest angle, then create the visual using Carousel Builder or AI Avatar Studio',
      'Pre-launch week content (days 1-7): do NOT mention the offer directly — build desire by talking about the problem, the transformation, and your story',
      'Launch window content (days 8-14): you can now mention the offer directly — mix value content with offer posts',
      'Schedule everything in Social Planner before your launch starts — nothing improvised during launch week',
      'The goal is that someone following you for 2 weeks becomes fully warm before they ever see a direct offer post',
    ],
    inputType: 'checklist',
    inputSchema: {
      type: 'checkbox',
      options: [
        { value: 'carousels_created', label: '4 carousels created', description: 'Educational content that builds authority — use the Carousel Builder' },
        { value: 'reels_created', label: '4 short-form video reels created', description: 'Hook, story, transformation, objection-handler — use AI Avatar Studio' },
        { value: 'static_posts_created', label: '4 caption/static posts created', description: 'Personal, behind-the-scenes, social proof, community-focused' },
        { value: 'offer_posts_created', label: '2 direct offer posts created', description: 'One for cart open day, one for last day with deadline' },
        { value: 'all_captions_written', label: 'All 14 captions are written and reviewed', description: 'Use the Hook Generator for angles, then customize for your voice' },
        { value: 'all_scheduled', label: 'All 14 pieces scheduled in Social Planner', description: 'Every post has a date, time, and platform assigned' },
      ],
    },
    aiAssistModes: ['generate', 'examples'],
    route: '/projects/:id/tasks/marketing_content_creation',
  },

  {
    taskId: 'marketing_campaign_setup',
    title: 'Set up your campaign and tracking links',
    phase: 'marketing',
    funnelTypes: ['all'],
    order: 3,
    priority: 1,
    ...
    skipReasonRequired: false,
    completionCriteria: [
      'A campaign is created in Launchely for this launch',
      'At least 3 UTM tracking links are built and saved',
      'You know how to check your tracking data',
    ],
    whyItMatters: 'Almost no beginner does this — which is exactly why you should. When you track where your clicks come from, you stop guessing and start knowing. After your launch, you\'ll see exactly which piece of content drove sales and which didn\'t. That data shapes every future launch. Without it, you\'re running blind — and the second launch is just as uncertain as the first.',
    instructions: [
      'Create a new campaign in Launchely\'s Campaigns tool for this launch — give it a name, set the start and end dates',
      'Build UTM tracking links for every traffic source you\'re using:',
      '— One link for your Instagram bio',
      '— One link for your email sequence CTA',
      '— One link for your TikTok bio (if applicable)',
      '— One link for each story or paid ad (if applicable)',
      'A UTM link looks like your sales page URL with tracking code added — the Launchely UTM Builder creates these automatically',
      'Replace your regular sales page link with the UTM link in every location (bio, emails, posts)',
      'Set up a simple daily tracking log — note: link clicks, page visits, email open rates, and sales each day',
      'After your launch, you\'ll run a debrief using this data — keep it somewhere you can find it',
    ],
    inputType: 'form',
    inputSchema: {
      type: 'form',
      fields: [
        {
          ...
          type: 'text',
          required: true,
          placeholder: 'e.g., Summer 2025 Coaching Launch',
          helperText: 'Give it a name you\'ll recognize when reviewing data later.',
        },
        {
          name: 'traffic_sources',
          label: 'Which traffic sources are you tracking?',
          type: 'textarea',
          required: true,
          placeholder: 'e.g., Instagram bio, email sequence, TikTok bio, Facebook group...',
          helperText: 'List every place you\'ll share your sales page link — you\'ll build one UTM link per source.',
        },
        {
          name: 'tracking_method',
          label: 'How will you track daily numbers?',
          type: 'text',
          required: false,
          placeholder: 'e.g., Google Sheet, Notion doc, paper notebook...',
          helperText: 'Keep it simple. You just need somewhere to record daily: clicks, visits, opens, sales.',
        },
      ],
    },
    aiAssistModes: ['help_me_choose', 'examples'],
    route: '/projects/:id/tasks/marketing_campaign_setup',
  },

  {
    taskId: 'marketing_engagement_sprint',
    title: 'Complete the 5-Day Engagement Sprint',
    phase: 'marketing',
    funnelTypes: ['all'],
    order: 4,
    priority: 2,
    estimatedMinutesMin: 150,
    estimatedMinutesMax: 150,
    blocking: false,
    dependencies: ['marketing_content_creation'],
    canSkip: true,
    skipReasonRequired: false,
    completionCriteria: [
      '5 days of intentional engagement completed',
      'All 3 daily actions completed each day',
    ],
    whyItMatters: 'Algorithms reward active, engaged accounts — and so do people. When you\'re genuinely present in the conversations your audience is already having, you build visibility and credibility without paying for ads. The 5 days before launch are the highest-leverage window to do this. Showing up in the right places right before your offer goes live means your name is already familiar to people who see it for the first time on launch day.',
    instructions: [
      'This sprint runs for 5 consecutive days — ideally the 5 days before your launch opens',
      'Each day, complete all 3 actions (30 minutes total per day):',
      '',
      'ACTION 1 — Reply to everything (10 min):',
      'Go through every comment, DM, and reply you\'ve received. Respond to each one. Don\'t let any engagement go unanswered — every reply extends your reach and signals to the algorithm that your content is worth showing to more people.',
      '',
      'ACTION 2 — Leave 10 meaningful comments (10 min):',
      'Go to 10 accounts your ideal audience follows — not your competitors, but the people your audience already trusts. Leave a genuine comment that adds something to the conversation. Not "great post." A real sentence. Your name will show up in their followers\' feeds.',
      '',
      'ACTION 3 — Show up in one community (10 min):',
      'Go to one place where your audience hangs out: a Facebook group, a Skool community, a Reddit thread, a LinkedIn group. Answer a question, add a perspective, start a conversation. You\'re not promoting anything — you\'re being helpful and visible.',
      '',
      'Track each day by checking the boxes below. When all 5 days are done, mark the task complete.',
    ],
    inputType: 'checklist',
    inputSchema: {
      type: 'checkbox',
      options: [
        { value: 'day_1', label: 'Day 1 complete', description: 'Replied to all comments/DMs · Left 10 meaningful comments · Showed up in 1 community' },
        { value: 'day_2', label: 'Day 2 complete', description: 'Replied to all comments/DMs · Left 10 meaningful comments · Showed up in 1 community' },
        { value: 'day_3', label: 'Day 3 complete', description: 'Replied to all comments/DMs · Left 10 meaningful comments · Showed up in 1 community' },
        { value: 'day_4', label: 'Day 4 complete', description: 'Replied to all comments/DMs · Left 10 meaningful comments · Showed up in 1 community' },
        { value: 'day_5', label: 'Day 5 complete', description: 'Replied to all comments/DMs · Left 10 meaningful comments · Showed up in 1 community' },
      ],
    },
    aiAssistModes: ['simplify'],
    route: '/projects/:id/tasks/marketing_engagement_sprint',
  },
