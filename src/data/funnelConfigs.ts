    ...
    offerSlots: [
      {
        ...
        description: 'Free resource to capture emails',
        isRequired: true,
        recommendedOfferTypes: ['Ebook/Guide', 'Checklist', 'Template'],
        priceRange: 'Free',
      },
      {
        type: 'tripwire',
        label: 'Low-Ticket Offer',
        description: 'Main low-priced product',
        isRequired: true,
        recommendedOfferTypes: ['Workshop', 'Template Bundle', 'Mini-Course'],
        priceRange: '$17-$97',
      },
      {
        type: 'upsell',
        label: 'Order Bump / Upsell',
        description: 'Additional offer at checkout',
        isRequired: false,
        recommendedOfferTypes: ['Implementation Guide', 'Done-For-You Templates', 'Bonus Training'],
        priceRange: '$27-$197',
      },
    ],
    assets: [
