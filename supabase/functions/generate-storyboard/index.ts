...
- For longer durations (10s): the video_prompt MUST be significantly longer and more detailed. Describe a CHAIN of 4-6 distinct sequential actions that flow naturally into each other. Each action should use a different body part or interact with a different element in the environment. Include: full-body movement (walking, turning, leaning), hand actions (picking up objects, adjusting accessories, touching surfaces), facial micro-expressions, weight shifts, environmental interactions (opening a door, setting down a glass, pulling out a chair). The prompt should read like a detailed choreography — NO repeated movements, NO loops, NO cycling back to the starting position. Every second must introduce new visual information.
...
- Example (3-5s, holding prop): "She flips the envelope in her hand, tucks it under her arm, rolls her shoulders back and glances around the room, ambient light catching her skin"
- Example (10s, kitchen): "She reaches for the coffee cup, lifts it and takes a slow sip, sets it back on the marble counter with a soft clink, wipes her lip with her thumb, then turns to the window — leans one hip against the counter, crosses her ankles, reaches up to tuck a strand of hair behind her ear, glances down at her phone on the counter, picks it up and scrolls briefly, sets it face-down, then pushes off the counter and walks toward the fridge, steam still curling from the cup behind her"
- Example (10s, no props, alone): "She shifts her weight to one hip, crosses her arms and scans the room left to right, uncrosses her arms and adjusts her jacket collar, takes a visible breath, tucks hair behind her ear, then takes two steps forward — pauses to straighten her sleeve, tilts her head considering something, turns 45 degrees to face the window, places one hand on the windowsill, drums her fingers once, then looks over her shoulder with a slight smile"
